...
const (
	...
	DISABLED SW_MUX_CTL = 0x00 << 4 //  Input Path is determined by functionality
	ENABLED  SW_MUX_CTL = 0x01 << 4 //  Force input path of pad GPIO_EMC_00
)
...
const (
	...
	SRE_0_Slow_Slew_Rate               SW_PAD_CTL = 0x00 << 0  //  Slow Slew Rate
	SRE_1_Fast_Slew_Rate               SW_PAD_CTL = 0x01 << 0  //  Fast Slew Rate
	...
	ODE_0_Open_Drain_Disabled          SW_PAD_CTL = 0x00 << 11 //  Open Drain Disabled
	ODE_1_Open_Drain_Enabled           SW_PAD_CTL = 0x01 << 11 //  Open Drain Enabled
	PKE                                SW_PAD_CTL = 0x01 << 12 //+ Pull / Keep Enable Field
	PKE_0_Pull_Keeper_Disabled         SW_PAD_CTL = 0x00 << 12 //  Pull/Keeper Disabled
	PKE_1_Pull_Keeper_Enabled          SW_PAD_CTL = 0x01 << 12 //  Pull/Keeper Enabled
	PUE                                SW_PAD_CTL = 0x01 << 13 //+ Pull / Keep Select Field
	PUE_0_Keeper                       SW_PAD_CTL = 0x00 << 13 //  Keeper
	PUE_1_Pull                         SW_PAD_CTL = 0x01 << 13 //  Pull
	...
	HYS_0_Hysteresis_Disabled          SW_PAD_CTL = 0x00 << 16 //  Hysteresis Disabled
	HYS_1_Hysteresis_Enabled           SW_PAD_CTL = 0x01 << 16 //  Hysteresis Enabled
)
